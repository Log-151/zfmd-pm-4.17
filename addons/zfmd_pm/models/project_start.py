...
class ZfmdProjectStart(models.Model):
    ...
    estimated_contract_amount = fields.Float(string="预计合同金额（万元）")
    estimated_contract_amount_text = fields.Char(string="预计合同金额原文")
    estimated_cost_amount = fields.Float(string="预计成本（万元）")
    estimated_cost_amount_text = fields.Char(string="预计成本原文")
    actual_contract_amount = fields.Float(string="实际合同金额（万元）")
