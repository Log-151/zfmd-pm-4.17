...
const FIELD_WHITELISTS = {
    ...
    "zfmd.invoice.record": [
        "actual_payment_amount", "actual_payment_date", "amount_untaxed", "cancel_date", "cancel_reason",
